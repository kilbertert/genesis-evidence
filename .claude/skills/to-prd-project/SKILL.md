...
This skill writes a PRD and publishes it as a GitHub issue in `kilbertert/genesis-evidence`. It does **not** apply `agent:implement` — labeling happens _after_ sub-issues have been created.
